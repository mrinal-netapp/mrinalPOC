...
import type { BlockHandlesConfig } from '@/types/handle-system'
...
export type SubBlockType =
  ...
  | 'mcp-server-selector' // Tool selector
  ...
  | 'sql' // SQL code editor with syntax highlighting
...
export interface BlockConfig {
  ...
  /**
   * Handle configuration for multi-handle support
   * If not defined, default handles will be used (one input, one output)
   */
  handles?: BlockHandlesConfig
}
