...
export const McpBlock: BlockConfig = {
  ...
  longDescription:
    'Integrate MCP into the workflow. Execute tools from configured MCP servers. Requires MCP servers in project settings.',
  docsLink: 'https://docs.agentstudio.io/mcp',
  category: 'tools',
  bgColor: '#181C1E', // Dark - Special theme (keeping existing)
  icon: ServerIcon,
  subBlocks: [
    {
      id: 'server',
      ...
      description: 'Choose from configured MCP servers in your project',
    },
    {
      id: 'tool',
      title: 'Tool',
