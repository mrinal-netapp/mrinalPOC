...
/**
 * Generates short, URL-safe agent team IDs
 * Format: agr-<8 alphanumeric lowercase characters>
 *
 * Example: agr-abc123xy
 * Total length: 12 characters (4 for prefix, 8 for random)
 */
export class AgentTeamIdGenerator {
  private static readonly BASE36 = '0123456789abcdefghijklmnopqrstuvwxyz';
  private static readonly PREFIX = 'agr-';
